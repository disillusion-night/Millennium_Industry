...
public class CrystallizerScreen extends AbstractDeviceSC<MeltingFurnaceContainer> {
    ...
    private static final Vector2i SnowPos = new Vector2i(82, 53);
    ...
    public CrystallizerScreen(MeltingFurnaceContainer pMenu, Inventory pPlayerInventory, Component pTitle) {
        super(pMenu, pPlayerInventory, pTitle);
        this.GUI_TEXTURE = getRL( "textures/gui/container/crystallizer_gui.png");
    }
