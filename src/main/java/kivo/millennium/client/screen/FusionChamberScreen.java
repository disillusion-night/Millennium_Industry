...
public class FusionChamberScreen extends AbstractDeviceSC<FusionChamberContainer> {
    ...
    public FusionChamberScreen(FusionChamberContainer pMenu, Inventory pPlayerInventory, Component pTitle) {
