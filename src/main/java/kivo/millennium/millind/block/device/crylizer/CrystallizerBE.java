package kivo.millennium.millind.block.device.crylizer;
...
public class CrystallizerBE extends AbstractMachineBE{
    ...
    public CrystallizerBE(BlockPos pWorldPosition, BlockState pBlockState) {
        super(MillenniumBlockEntities.CRYSTALLIZER_BE.get(), pWorldPosition, pBlockState, new CapabilityCache.Builder()
    ...
    public void tickServer() {
        ...
        if (!inputStack.isEmpty()) {
            ExtendedContainer container = new ExtendedContainer();
            Optional<MeltingRecipe> recipe = level.getRecipeManager().getRecipeFor(MeltingRecipe.Type.INSTANCE, container, level);
