...
public class FusionChamberContainer extends AbstractDeviceMenu {
    ...
    public FusionChamberContainer(int pContainerId, Player player, BlockPos pos) {
    ...
    protected void setupDataSlot(Container container, AbstractMachineBE deviceBE) {
        ...
        addDataSlot(new DataSlot() {
            ...
            public void set(int pValue) {
                FusionChamberContainer.this.progressAndLit = (FusionChamberContainer.this.progressAndLit & 0xffff0000) | (pValue & 0xffff);
            }
        });
        addDataSlot(new DataSlot() {
            @Override
            ...
            @Override
            public void set(int pValue) {
                FusionChamberContainer.this.fluidAmountIn = (FusionChamberContainer.this.fluidAmountIn & 0xffff0000) | (pValue & 0xffff);
            }
        });
        addDataSlot(new DataSlot() {
            @Override
            ...
            @Override
            public void set(int pValue) {
                FusionChamberContainer.this.fluidAmountIn = (FusionChamberContainer.this.fluidAmountIn & 0xffff) | ((pValue & 0xffff) << 16);
            }
        });
        addDataSlot(new DataSlot() {
            @Override
            ...
            @Override
            public void set(int pValue) {
                FusionChamberContainer.this.fluidCapacityIn = (FusionChamberContainer.this.fluidCapacityIn & 0xffff0000) | (pValue & 0xffff);
            }
        });
        addDataSlot(new DataSlot() {
            @Override
            ...
            @Override
            public void set(int pValue) {
                FusionChamberContainer.this.fluidCapacityIn = (FusionChamberContainer.this.fluidCapacityIn & 0xffff) | ((pValue & 0xffff) << 16);
            }
        });
        addDataSlot(new DataSlot() {
            @Override
            ...
            @Override
            public void set(int pValue) {
                FusionChamberContainer.this.fluidAmountOut = (FusionChamberContainer.this.fluidAmountOut & 0xffff0000) | (pValue & 0xffff);
            }
        });
        addDataSlot(new DataSlot() {
            @Override
            ...
            @Override
            public void set(int pValue) {
                FusionChamberContainer.this.fluidAmountOut = (FusionChamberContainer.this.fluidAmountOut & 0xffff) | ((pValue & 0xffff) << 16);
            }
        });
        addDataSlot(new DataSlot() {
            @Override
            ...
            @Override
            public void set(int pValue) {
                FusionChamberContainer.this.fluidCapacityOut = (FusionChamberContainer.this.fluidCapacityOut & 0xffff0000) | (pValue & 0xffff);
            }
        });
        addDataSlot(new DataSlot() {
            @Override
            ...
            @Override
            public void set(int pValue) {
                FusionChamberContainer.this.fluidCapacityOut = (FusionChamberContainer.this.fluidCapacityOut & 0xffff) | ((pValue & 0xffff) << 16);
            }
        });
        addDataSlot(new DataSlot() {
            @Override
            ...
            @Override
            public void set(int pValue) {
                FusionChamberContainer.this.fluidIdIn = pValue;
            }
        });
        addDataSlot(new DataSlot() {
            @Override
            ...
            @Override
            public void set(int pValue) {
                FusionChamberContainer.this.fluidIdOut = pValue;
            }
        });
    }
