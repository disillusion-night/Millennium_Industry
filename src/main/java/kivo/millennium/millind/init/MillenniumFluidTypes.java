...
public class MillenniumFluidTypes {
    ...
    public static final RegistryObject<FluidType> MOLTEN_ALUMINUM_ALLOY_FT = FLUID_TYPES.register("molten_aluminum_alloy", () -> new MoltenAluminumAlloyFT(FluidType.Properties.create()));
