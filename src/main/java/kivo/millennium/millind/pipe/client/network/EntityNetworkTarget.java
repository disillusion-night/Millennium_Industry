...
public class EntityNetworkTarget extends NetworkTarget {
    ...
    public boolean isValid(Level level) {
        ...
        // 注意：level.getEntities().get(entityUuid) 需要 Minecraft 1.16+
        // 对于旧版本，可能需要遍历 level.getEntities().getAll() 或使用其他方法
        Entity entity = null;
        ...
        return entity != null && entity.getCapability(ForgeCapabilities.ENERGY /*, capabilityDirection */).isPresent();
    }
