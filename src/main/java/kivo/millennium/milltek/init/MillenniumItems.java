...
public class MillenniumItems {
    ...
    public static final RegistryObject<Item> TITANIUM_ALLOY_SWORD = createTool("titanium_alloy_sword",
            () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, (new Item.Properties()).fireResistant()));
    public static final RegistryObject<Item> TITANIUM_ALLOY_SHOVEL = createTool("titanium_alloy_shovel",
            () -> new ShovelItem(Tiers.DIAMOND, 1.5F, -3.0F, (new Item.Properties()).fireResistant()));
    public static final RegistryObject<Item> TITANIUM_ALLOY_PICKAXE = createTool("titanium_alloy_pickaxe",
            () -> new PickaxeItem(Tiers.DIAMOND, 1, -2.8F, (new Item.Properties()).fireResistant()));
    public static final RegistryObject<Item> TITANIUM_ALLOY_AXE = createTool("titanium_alloy_axe",
            () -> new AxeItem(Tiers.DIAMOND, 5.0F, -3.0F, (new Item.Properties()).fireResistant()));
    public static final RegistryObject<Item> TITANIUM_ALLOY_HOE = createTool("titanium_alloy_hoe",
            () -> new HoeItem(Tiers.DIAMOND, -4, 0.0F, (new Item.Properties()).fireResistant()));
    ...
    // public static final RegistryObject<Item> STEEL_FM =
    // createMaterial("steel_bm");

    public static final RegistryObject<Item> STEEL_SWORD = createTool("steel_sword",
            () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, (new Item.Properties())));
    public static final RegistryObject<Item> STEEL_SHOVEL = createTool("steel_shovel",
            () -> new ShovelItem(Tiers.DIAMOND, 1.5F, -3.0F, (new Item.Properties())));
    public static final RegistryObject<Item> STEEL_PICKAXE = createTool("steel_pickaxe",
            () -> new PickaxeItem(Tiers.DIAMOND, 1, -2.8F, (new Item.Properties())));
    public static final RegistryObject<Item> STEEL_AXE = createTool("steel_axe",
            () -> new AxeItem(Tiers.DIAMOND, 5.0F, -3.0F, (new Item.Properties())));
    public static final RegistryObject<Item> STEEL_HOE = createTool("steel_hoe",
    ...
    public static final RegistryObject<Item> WOLFRAM_STEEL_SWORD = createTool("wolfram_steel_sword",
            () -> new SwordItem(Tiers.NETHERITE, 3, -2.4F, (new Item.Properties()).fireResistant()));
    public static final RegistryObject<Item> WOLFRAM_STEEL_SHOVEL = createTool("wolfram_steel_shovel",
            () -> new ShovelItem(Tiers.NETHERITE, 1.5F, -3.0F, (new Item.Properties()).fireResistant()));
    public static final RegistryObject<Item> WOLFRAM_STEEL_PICKAXE = createTool("wolfram_steel_pickaxe",
            () -> new PickaxeItem(Tiers.NETHERITE, 1, -2.8F, (new Item.Properties()).fireResistant()));
    public static final RegistryObject<Item> WOLFRAM_STEEL_AXE = createTool("wolfram_steel_axe",
    ...
    // public static final RegistryObject<Item> FACADE_BLOCK_ITEM =
    // ITEMS.register("facade", () -> new FacadeBlockItem(FACADE_BLOCK.get(), new
    // Item.Properties()));
    ...
    private static RegistryObject<BaseBattery> createBattery(String name, int Capacity, int MaxTransfer) {
        RegistryObject<BaseBattery> battery = ITEMS.register(name,
                () -> new BaseBattery(new Item.Properties().rarity(Rarity.UNCOMMON).stacksTo(1), Capacity,
                        MaxTransfer));
