...
import kivo.millennium.milltek.pipe.network.EnergyPipeNetwork;
...
public class MillenniumLevelNetworkType {
    ...
    */
    // 能量网络注册
    public static final RegistryObject<LevelNetworkType<EnergyPipeNetwork>> ENERGY_PIPE_NETWORK = LEVEL_NETWORK_TYPES
            .register(
                    "energy_pipe_network",
