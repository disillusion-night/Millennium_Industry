...
public class ElectrolyzingRecipe extends GenericRecipe {
    public ElectrolyzingRecipe(ResourceLocation id, List<RecipeComponent> inputs, List<RecipeComponent> outputs,
            int time,
            int energyCost) {
    ...
    public static class Serializer extends GenericRecipe.Serializer<ElectrolyzingRecipe> {
        ...
        public Serializer(RecipeFactory<ElectrolyzingRecipe> factory) {
            super(factory);
        }
    }
